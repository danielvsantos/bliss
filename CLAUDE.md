...
|-------|---------|-----------|-------|
| All | `pnpm test` | -- | 1,543 tests |
| API | `pnpm test:api` | Vitest (ESM) | 429 tests (unit + integration) |
| Backend | `pnpm test:backend` | Jest (CJS) | 856 tests (unit + integration) |
| Frontend | `pnpm test:web` | Vitest + RTL | 258 tests |
