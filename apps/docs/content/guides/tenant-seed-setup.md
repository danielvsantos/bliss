# Seed Your Financial World

If you have many accounts across multiple banks and countries, the tenant seed script lets you create them all at once instead of adding them one by one through the UI.
