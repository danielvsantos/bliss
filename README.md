...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1426%20passing-brightgreen" alt="Tests" />
...
```bash
pnpm test              # run all 1,426 tests across all apps
pnpm test:api          # 428 tests (Vitest) — unit + integration
pnpm test:backend      # 757 tests (Jest) — unit + integration
