...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-2209%20passing-brightgreen" alt="Tests" />
...
```bash
pnpm test              # run all 2,209 tests across all apps
pnpm test:api          # 663 tests (Vitest) — unit + integration
pnpm test:backend      # 1,010 tests (Jest) — unit + integration
