...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1429%20passing-brightgreen" alt="Tests" />
...
```bash
pnpm test              # run all 1,429 tests across all apps
pnpm test:api          # 428 tests (Vitest) — unit + integration
pnpm test:backend      # 760 tests (Jest) — unit + integration
pnpm test:web          # 241 tests (Vitest + MSW) — hooks, pages, components, contexts
```
