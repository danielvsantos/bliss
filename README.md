...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-2233%20passing-brightgreen" alt="Tests" />
...
```bash
pnpm test              # run all 2,233 tests across all apps
pnpm test:api          # 675 tests (Vitest) — unit + integration
pnpm test:backend      # 1,017 tests (Jest) — unit + integration
