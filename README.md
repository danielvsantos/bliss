...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-1419%20passing-brightgreen" alt="Tests" />
...
```bash
pnpm test              # run all 1,419 tests across all apps
pnpm test:api          # 428 tests (Vitest) — unit + integration
pnpm test:backend      # 750 tests (Jest) — unit + integration
